function BinaryReader(stream) {
	...
	this.readInt64 = function() {
		...
		//console.log(this.readByte()+' '+this.readByte()+' '+this.readByte()+' '+this.readByte());
		var high = this.readInt32();
		high = high * (1<<30)*2*2;
		console.log(this._toString(low,16)+' '+this._toString(high,16)+' '+low+' '+high);
		return (high+low);
	};
...
function BinaryWriter() {
	...
	this.writeInt64 = function(l) {
		...
		var high=(l - (l > 0 ? 1 : -1) * (l & 0xFFFFFFFF))
				/ ((0x7FFFFFFF) * 2)+(l<0?-1:1) ;
		console.log(l+' '+this._toString(low,16)+' '+this._toString(high,16));
...
var l=-1234567891234;
console.log(w._toString((l - (l > 0 ? 1 : -1) * (l & 0xFFFFFFFF))
				/ ((0x7FFFFFFF) * 2)+(l<0?-1:0) ,16)+' '+w._toString(l,16));
console.log('i='+w._toString(-1,16));
var e=encodeBSON({a2:1.333,a3:l,a1:null,hello:"world",a:1,b:{z:3,a:"привет утф8",ar:[123,234],r:/[a]/ig}});
console.dir(e);
console.dir(decodeBSON(e));
